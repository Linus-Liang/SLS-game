...
export function main(keyBinder, pointer) {
    ...
    const program = glUtils.compileProgram(loaded.gradient1.vertex, loaded.gradient1.fragment);
    ...
    return (time) => {
        ...
        // gl.clearColor(Math.cos(time / 1000.0), Math.sin(time / 1000.0), Math.tan(time / 1000.0), 1.0);
        // gl.clearDepth(1.0);
